...
Replace this section with the supported versions for `workspacewire`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `workspacewire` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in workspacewire.
